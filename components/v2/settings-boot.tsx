...
/**
 * SettingsBoot — applies user-preference classes (theme, density, ambient,
 * wallpaper, motion) before first paint to avoid a visible flash.
 * The tiny inline script reads localStorage and toggles html/body classes.
...
(function(){try{
  ...
  h.classList.toggle('light', light);
  h.classList.toggle('dark', !light);
